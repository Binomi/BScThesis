...
\begin{figure}[!htb]
	\centering
	\subfloat[Antwortverhalten der beiden Photodioden: Bei steigender Leistung sättigt die Peakspannung und die Photodoiden-Antwort wird länger.\label{fig:PDfwhmMaxI}]
   {\includegraphics[width=0.49\textwidth]{figures/PDfwhmMaxI}}
   \hfill
   \subfloat[2\,mW\label{fig:PD2mW}]
...
\begin{figure}
	\centering
	\includegraphics[scale=1.0]{figures/bounceColl3.pdf}
\end{figure} 
