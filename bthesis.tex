...
Sie können auch stabile Multipulsformationen, sogenannte \textit{Solitonen-Moleküle} bilden.
...
Neben linearer Verstärkung $\alpha$ sowie Verlusten $\rho$ beeinflusst die Kerr-Linse noch die Pulsamplitude.
Diese wird als schneller sättigbarer Absorber moduliert, dh. höhere Intensitäten erfahren weniger Verluste.
...
Das Spektrum des Pulses wird auf durch das spektrale Verstärkungsprofil beeinflusst.
...
Der Übersichtlichkeit halber werden neue einheitenlose Größen definiert.
So gibt $P=(I_p\sigma_a/h\nu_a)T_\text{cav}$ die Pumpstärke an, $E_s=h\nu/\sigma_g$ ist die Sättigungsenergie des Kristalls und $E=\int_0^{T_\text{cav}}\dif t \,|A(z,t)|^2$ die Gesamtenergie pro Laserumlauf.
Es ergibt sich also:
\begin{align}
...
Einige der zuvor beschriebenen Parameter sind Materialkonstanten für Titan:Saphir.
...
Diese beiden faszinierenden Dynamiken können nur schwer mit herkömmlichen Methoden gemessen werden, da diese in der Mittlung über viele Laserumläufe verschwinden.
...
Die Stärke von Echtzeit-Methoden liegt vor allem im Enthüllen von \textbf{transienten Dynamiken}, welche hier z.B. während der Pulsentstehung (Abschnitt \ref{sec:startTransient}) sowie durch Automodulationen der Laserleistung (Abschnitt \ref{sec:automod}) beobachtet wurden.
...
Durch Mittlung über mehrere Umläufe kann dies erhöht werden.
