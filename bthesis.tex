...
Mit der hier genutzten Methode der \textit{dispersiven Fouriertransformation} sowie \textbf{Hochgeschwindigkeitselektronik} bestehend aus schnellen Photodetektoren und den schnellsten, kommerziell erhältlichen AD-Wandlern ist es nun möglich, das Spektrum jedes Pulspaares aufzunehmen und daraus den Abstand sowie die Phase zwischen den beiden Pulsen zu bestimmen.
...
\begin{figure}[!htb]
	...
	\caption{Beispielhafte Doppelpulse: Intensität, Spektrum und Autokorrelation.}
	\label{fig:PulsBsp}
\end{figure}
...
Wie von \cite[S.66]{lauterborn_coherent_2003} beschrieben, ergeben sich Frequenzabstände von
\begin{align*}
	\Delta \nu=\frac{c}{2Ln}\,,
\end{align*}
...
Der kleine Unterschied kann auch durch eine leicht unterschiedliche Einstrahlung bedingt sein.
Insgesamt sind beide Werte aber im guten Einklang mit der aus dem Datenblatt\footnote{\url{http://www.alphalas.com/images/stories/products/laser_diagnostic_tools/Ultrafast_Photodetectors_UPD_ALPHALAS.pdf}, abgerufen am 08.02.2016} entnommenen Sensitvitätskurve in Abb.\ref{fig:PDsensDB}

\begin{figure}[!htb]
	\centering
	\subfloat[Mittlerer Stromfluss skaliert linear mit eingestrahlter Leistung.
	Steigung entspricht Sensitivität.\label{fig:PDdispMeanA}]
...
Die hier beobachteten Doppelpulse sind etwa 95\,fs bis 115\,fs voneinander getrennt, der Abstand der Pulse ändert sich also nicht gravierend.
...
\begin{figure}[!htb]
   ...
   \caption{Gebundene Pulse: Spektren bei Änderung der Pumpleistung.}
...
\begin{figure}[!htb]
   ...
   {\includegraphics[width=0.46\textwidth]{figures/400ms_5musHold_25GSA_400m_MLrun_runBounceFix_4,41W_Ch2}}
   \hfill
   \subfloat[Zeitliche Entwicklung der beiden Puls\-energien (proportional zur Peakspannung) und der Differenz der Umlaufzeit\label{fig:rBF441peakTau}]
   {\includegraphics[width=0.46\textwidth]{figures/runningPeakTau}}
...
Bei dieser Messreihe ist der Laser etwas besser als zuvor justiert, sodass die Ausgangsleistung höher ist und somit sogar Dreifachpulse möglich sind.
...
Außerdem stehen die Triplett-Zustände im Fokus.

\subsection{Stufenweise Phasenentwicklung gebundener Doppelpulse}
Hier beginnt die Messreihe mit Doppelpulsen, deren Phase und relativer Abstand fix sind (Abb. \ref{fig:165014steps} A+B).
Der Abstand liegt etwa bei 170 \,fs.
Dann wird die Pumpleistung verringert.
Dabei wird beobachtet, dass der Abstand der beiden Pulse immer noch sehr konstant ist, während die Phase jedoch beginnt, in $2\pi$-Schüben/Sprüngen durchzulaufen (vgl. Abb. \ref{fig:165014steps} C-F).
...
Für hohe Pumleistungen hingegen kann es zu einem Locken der Phase kommen.
...
Der Intensitätsunterschied nimmt also kurzzeitig extrem zu bis sich wieder ein annähernd stabiler Zustand eingestellt hat.
...
\begin{figure}
	...
	\caption{Anzahl an Roundtrips, innerhalb deren die relative Phase um $2\pi$ zunimmt, in Abängigkeit der Pumpleistung: Die relative Phase wächst bei niedrigen Pumpleistungen schneller an.}
   \label{fig:jumpRT}
\end{figure} 
...
\begin{figure}
	...
	\caption{Phasenentwicklung wird je nach Pumpleistung mit der in Abb. \ref{fig:jumpRT} berechneten Zeit skaliert.}
...
In Abbildung \ref{fig:Triplett} ist die spektrale Entwicklung sowie die Autokorrelation vier verschiedener Triplett-Zustände dargestellt, die sich nach mehrmaligem Stören aus dem cw-Betrieb einstellen.
...
Diese Abstände sind etwas größer als die von \cite{kitano_stable_1998} für zwei 15\,fs-Pulse gemessenen Abstände von 98\,fs, 164\,fs, 259\,fs sowie 312\,fs.
