...
\begin{abstract}
  In this paper the spectra of an 80\,MHz Ti:sapph oscillators are measured in real-time.
  ...
  The used measurement technique allows observations of transient processes like the build-up of a femtosecond pulse pair.
