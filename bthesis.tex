...
Diese haben im Lasermedium dispersionsbedingt unterschiedliche Ausbreitungsgeschwindigkeiten.
Dies würde dazu führen, dass der Puls zerläuft.
...
Dies führt zu Soliton-ähnlichen Pulszuständen.
Ein Titan:Saphir-Laser eignet sich also hervorragend, um solche Systeme zu studieren.
...
In Abbildung \ref{fig:map} wird letzterer bei verschiedenen Kristallpositionen variiert.
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.8\textwidth]{figures/map2.pdf}
...
\begin{figure}[!htb]
	\centering
	\subfloat[verschiedene Kristallpositionen\label{fig:map1}]
   {\includegraphics[width=0.49\textwidth]{figures/map.pdf}}
   \hfill
   \subfloat[Unterschied zwischen den einzelnen Betrieben.\label{fig:map2}]
   {\includegraphics[width=0.49\textwidth]{figures/map2.pdf}}
	\caption{Abhängigkeit der Leistung (cw \& gemodelockt) von der Position des fokussierenden Spiegels (Stabilität).
	Die Positionen werden von außen gemessen, dh. dass größere Werte einer Verringerung des Abstandes zum festen Fokussierspiegel entsprechen.}
	\label{fig:map}
\end{figure}
